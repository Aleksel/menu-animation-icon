...
var BentoMenu = function (_CommonMenu) {
    ...
    function BentoMenu() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = BentoMenu.__proto__ || (0, _getPrototypeOf2.default)(BentoMenu)).call.apply(_ref, [this].concat(args))), _this), _this.renderLines = function (className, styleLine) {
            return (0, _from2.default)(Array(9).keys()).map(function (index) {
                return _react2.default.createElement('div', { key: index, className: 'CommonMenu_box ' + className + '_box', style: styleLine });
            });
        }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }

    return BentoMenu;
}(_Common2.default); /* eslint-disable import/no-extraneous-dependencies */
